(function () {
    ...
    angular.module('main', ['firebase', 'ngRoute', 'main.controllers', 'main.factories', 'main.directives', 'main.filters'])
        ...
        .run(['$rootScope', '$firebase', 'FIREBASE_URL', 'User', '$location',

            function ($rootScope, $firebase, FIREBASE_URL, User, $location) {
                ...
                $rootScope.$on('$firebaseSimpleLogin:login', function (e, user) {
                    ...
                    Username.$loaded(function () {
                        ...
                        if (User.signedIn() && $rootScope.currentUser.username) $location.path($rootScope.currentUser.username);
                    });
